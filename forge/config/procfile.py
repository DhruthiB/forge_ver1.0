...
from forge.utils import which


def setup_procfile(forge_path, yes=False, skip_redis=False, skip_web=False, skip_watch=None, skip_socketio=False, skip_schedule=False, with_coverage=False):
	...
	procfile_path = os.path.join(forge_path, "Procfile")
