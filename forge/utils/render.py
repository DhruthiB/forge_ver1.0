...
class Rendering:
	def __init__(self, success, title, is_parent, args, kwargs):
		...
		self.dynamic_feed = forge.cli.from_command_line and forge.cli.dynamic_feed
...
def job(title: str = None, success: str = None):
	...
	For instance, the `get-app` command consists of two jobs: `initializing forge`
